...
class Youtube_Dataset(BaseDataset):
    def initialize(self, opt):
        ...
        opt.numClasses = len(self.tex2flow_mapping) #self.numClasses
        opt.numFlowClasses = len(self.flow2tex_mapping) #self.numFlowClasses
        ...
        for curr_path in self.img_paths:
            ...
            underscore_token = curr_path.rfind('_')

            curr_id = curr_path[last_slash+1:underscore_token]
    ...
    def __getitem__(self, index):
        ...
        for i in range(len(imgs_list)):
            ...
            underscore_token = curr_img.rfind('_')
            dot_token = curr_img.rfind('.')
            age = int(curr_img[underscore_token+1:dot_token])
        ...
        return {'Imgs': out_imgs, 'facial_hair': out_facial_hair,
                ...
                'Paths': imgs_list, 'Classes': img_classes, 'flow_Classes': flow_classes,
                'Valid': valid}
